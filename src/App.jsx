...
import { connectWs } from "./web-socket";
...
function App() {
    ...
    useEffect(()=>{
      ...
      socket.current.on('chatMessage',(msg)=>{
          //just push to existing messages list available 
          setMessages((prev)=>[...prev,msg]);
      })

      socket.current.on('typing',(userName)=>{
        setTypers((typers)=>{
          const ifexists=typers.find((typer)=>typer==userName);
          if(!ifexists) return  [...typers,userName];
    ...
    //handle to send msg from client 
